...
HTML;
	...
	// ---------------------------------------------------------------
	// Media, Users, Settings (unchanged from 2.1)
	// ---------------------------------------------------------------
	...
	private function mediaList(AdminLayout $layout): string
	{
		...
		$content = '<div class="kb-content-header"><h2>Media library</h2></div><div class="kb-card"><div class="kb-card-body"><div class="kb-empty"><h3>Media library</h3><p>Upload and manage images, documents, and files. Coming in Phase 2.3.</p></div></div></div>';
		return $layout->render($content);
	}
